...
public class LdaRecorder implements Serializable {
	...
	public void addDocuments(InstanceList additionalDocuments,
		...
		for (int di = numOldDocs; di < numDocs; di++) {
			try {
				...
				int start = absoFilePath.lastIndexOf("tag")+3;
	...
	public static void main(String[] args) throws IOException {
		String oldDocsLocation = "D:\\work\\experiment\\stackoverflow\\all.mallet";
		String newDocsLocation = "D:\\work\\experiment\\stackoverflow\\all.combined.mallet";
		String oldDocTopicLocation = "D:\\work\\experiment\\stackoverflow\\results\\old.doc.topic";
		String newDocTopicLocation = "D:\\work\\experiment\\stackoverflow\\results\\new.doc.topic";
