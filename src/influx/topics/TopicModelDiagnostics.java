...
public class TopicModelDiagnostics {
	...
	public TopicModelDiagnostics (NewParallelTopicModel model, int numTopWords) {
	...
	public static void main (String[] args) throws Exception {
		...
		NewParallelTopicModel model = new NewParallelTopicModel(numTopics, 5.0, 0.01);
