 ...
 * @param p1 : non-negative doubles!
 * @param p2 : non-negative doubles!
 * @return
 */
public static double cosineSimilarity(double[] p1, double[] p2) {
    ...
    denumerator = EuclidianMode(p1) * EuclidianMode(p2);
    if(denumerator==0)
    	cosine = 0.0;
    else
  ...
  /**
 * @author Shockley Xiang Li
 * @param p : non-negative doubles!
 * @return
 */
public static double EuclidianMode(double[] p){
	  double base = 0.0;
